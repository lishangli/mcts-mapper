module attributes {dlti.dl_spec = #dlti.dl_spec<#dlti.dl_entry<"dlti.endianness", "little">, #dlti.dl_entry<i64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f80, dense<128> : vector<2xi32>>, #dlti.dl_entry<i1, dense<8> : vector<2xi32>>, #dlti.dl_entry<i8, dense<8> : vector<2xi32>>, #dlti.dl_entry<i16, dense<16> : vector<2xi32>>, #dlti.dl_entry<i32, dense<32> : vector<2xi32>>, #dlti.dl_entry<f16, dense<16> : vector<2xi32>>, #dlti.dl_entry<f64, dense<64> : vector<2xi32>>, #dlti.dl_entry<f128, dense<128> : vector<2xi32>>>, llvm.data_layout = "e-m:e-p270:32:32-p271:32:32-p272:64:64-i64:64-f80:128-n8:16:32:64-S128", llvm.target_triple = "x86_64-unknown-linux-gnu", "polygeist.target-cpu" = "x86-64", "polygeist.target-features" = "+cx8,+fxsr,+mmx,+sse,+sse2,+x87", "polygeist.tune-cpu" = "generic"} {
  func.func @func(%arg0: memref<?xi32>, %arg1: memref<?xi32>) attributes {llvm.linkage = #llvm.linkage<external>} {
    ...
    ^bb0(%arg2: memref<?xi32>, %arg3: memref<?xi32>):
      ...
      cgra.node(%alloca, %arg3) -> (%arg3) {inputTaps = [0 : i32, 0 : i32], isLegal = true, pes = 7 : i32} : (memref<9xi32>, memref<?xi32>) -> memref<?xi32> {
      ^bb0(%arg4: memref<9xi32>, %arg5: memref<?xi32>, %arg6: memref<?xi32>):
        affine.for %arg7 = 0 to 9 {
          %c1_i32 = arith.constant 1 : i32
          %c3_i32 = arith.constant 3 : i32
          %c-1_i32 = arith.constant -1 : i32
          %c2_i32 = arith.constant 2 : i32
          %0 = affine.load %arg4[%arg7] : memref<9xi32>
          ...
          %7 = affine.load %arg5[0] : memref<?xi32>
          %8 = arith.addi %7, %6 : i32
          affine.store %8, %arg5[0] : memref<?xi32>
        }
      }
      cgra.node(%alloca, %arg2) -> (%arg2) {inputTaps = [0 : i32, 0 : i32], isLegal = true, pes = 12 : i32} : (memref<9xi32>, memref<?xi32>) -> memref<?xi32> {
      ^bb0(%arg4: memref<9xi32>, %arg5: memref<?xi32>, %arg6: memref<?xi32>):
        affine.for %arg7 = 0 to 9 {
          ...
          %12 = affine.load %arg5[0] : memref<?xi32>
          %13 = arith.addi %12, %11 : i32
          affine.store %13, %arg5[0] : memref<?xi32>
        }
      }
    }
    return
