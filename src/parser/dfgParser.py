...
class DFG:
    ...
    def __reduce__(self):
        ...
        For this simple DFG class, we can reconstruct it using its constructor (DFG())
        and then setting the nodes, edges, and name attributes.
        """
        return (self.__class__, (), self.__getstate__())

    def __getstate__(self):
        """
        Returns the state of the DFG object for pickling.
        We package the nodes, edges, and name into a tuple to represent the state.
        """
        return (self.nodes, self.edges, self.name)

    def __setstate__(self, state):
        """
        Restores the state of the DFG object during unpickling.
        We unpack the tuple from __getstate__ and set the corresponding attributes.
        """
        nodes, edges, name = state
        self.nodes = nodes
        self.edges = edges
        self.name = name
