...
if __name__ == "__main__":
    ...
    parser.add_argument('--route_kl_targ', type=float, default=0.1, help='Route KL target value')
    parser.add_argument('--check_freq', type=int, default=5, help='Check frequency')
    parser.add_argument('--target_latency', type=int, default=100, help='Target latency')
    ...
    parser.add_argument('--route_lr_multiplier', type=float, default=1.0, help='Route learning rate multiplier')
    ...
    # MCTS configuration
    parser.add_argument('--discount', type=float, default=0.99, help="RL reward discount")
    parser.add_argument('--c_param',type=float, default=4, help="MCTS exploration parameter")
    parser.add_argument('--expand_size', type=int, default=20, help="MCTS expand nodes size")
